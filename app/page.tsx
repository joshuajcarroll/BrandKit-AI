        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-tight">
              BrandKit<span className="text-indigo-400">AI</span>
            </span>
          </div>
          ...
          <nav className="flex items-center gap-3">
            <Link
              href="/pricing"
              className="hidden text-sm text-slate-300 hover:text-slate-50 sm:inline-block"
            >
              Pricing
            </Link>
            <Link
        ...
        <section className="border-b border-slate-800">
          <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 md:flex-row md:items-center md:py-24">
            <div className="flex-1 space-y-6">
              <Badge className="border border-indigo-500/40 bg-indigo-500/10 text-xs font-medium uppercase tracking-wide text-indigo-200">
                New • AI brand kit in 60 seconds
              </Badge>

              <h1 className="text-balance text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
                Launch your brand
                <span className="block bg-gradient-to-r from-indigo-400 via-sky-300 to-emerald-300 bg-clip-text text-transparent">
                  without a designer.
                </span>
              </h1>
            ...
            <div className="flex-1">
              <Card className="border-slate-800 bg-slate-900/70 backdrop-blur shadow-xl shadow-black/40">
                <CardHeader>
                  <CardTitle className="flex items-center justify-between gap-2 text-base">
                    ...
                    <Badge
                      variant="outline"
                      className="border-emerald-400/40 text-[10px] text-emerald-200"
                    >
                      Generated • 12s
                    </Badge>
                  </CardTitle>
                ...
                <CardContent className="space-y-6 text-xs text-slate-200">
                  {/* Colors */}
                  <div>
                  ...
                  <div className="grid gap-2 md:grid-cols-2">
                    <div>
                      ...
                      <p className="rounded-md bg-slate-800/70 px-3 py-2 text-sm font-semibold">
                        “Paw Palace”
                      </p>
                    ...
                    <div>
                      ...
                      <p className="rounded-md bg-slate-800/70 px-3 py-2 text-xs leading-relaxed">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="rounded-md bg-slate-800/70 px-3 py-2 text-[11px]">
                      Mobile dog grooming 🚐✨
                      <br />
        ...
        <section className="border-b border-slate-800 bg-slate-950/60">
          <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
            <h2 className="text-center text-xl font-semibold tracking-tight sm:text-2xl">
              ...
              <span className="text-indigo-300"> done for you.</span>
            </h2>
          ...
          <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
            <div className="grid gap-6 md:grid-cols-[2fr,3fr] md:items-center">
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-3 text-xs text-slate-400 sm:text-sm">
